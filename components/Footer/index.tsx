          ...
          <div className={styles.content}>
            ...
            <div className={styles.column}>
              ...
              <a 
                ...
                rel="noopener noreferrer"
              >
                <div><FaMapMarker size={20}/></div>
                Av. Prof. Almeida Prado, 128 - Butantã, São Paulo - SP, 05508-070
              </a>
            </div>
            <div className={styles.column}>
              <p className={styles.columnTitle}>Ensaios</p>
              <p className={styles.convite}>Ensaiamos às terças e quintas na praça do relógio! <br/><br/> Quer nos conhecer? Fale conosco!!</p>
            </div>
          </div>
